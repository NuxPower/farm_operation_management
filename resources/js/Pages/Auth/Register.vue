        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <PasswordInput
              ...
              required
              :input-class="['mt-1 appearance-none relative block w-full px-3 py-2 border placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm', errors.password ? 'border-red-300' : 'border-gray-300']"
          ...
          <div>
            ...
            <PasswordInput
              ...
              autocomplete="new-password"
              required
              input-class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
