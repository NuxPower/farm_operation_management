          ...
          <div class="bg-white rounded-lg shadow">
            ...
            <div class="divide-y divide-gray-200">
              ...
              >
                <div class="flex items-center space-x-4">
                  <!-- Product Image -->
                  <div class="h-20 w-20 bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
                    <img
                    ...
                    />
                    <svg v-else class="h-10 w-10 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
