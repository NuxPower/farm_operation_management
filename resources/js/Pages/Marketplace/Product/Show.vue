      ...
      <nav class="flex mb-8" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          <li class="inline-flex items-center">
            <router-link to="/marketplace/my-products" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-emerald-600">
          ...
          <li>
            <div class="flex items-center">
              ...
              <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">{{ product.name || 'Loading...' }}</span>
            </div>
          </li>
        </ol>
      </nav>
