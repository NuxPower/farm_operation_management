...
class RiceMarketplaceController extends Controller
{
    ...
    public function createProduct(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'unit' => 'required|string|in:kg,tons,sacks,bushels,pounds,grams,sacks_rice,sacks_palay,sacks_dried_palay',
    ...
    public function updateProduct(Request $request, $id)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'unit' => 'string|in:kg,tons,sacks,bushels,pounds,grams,sacks_rice,sacks_palay,sacks_dried_palay',
